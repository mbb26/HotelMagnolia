...
namespace Ulacit.Mandiola.DB.Concrete
{
    ...
    public class RolContext : IRolContext
    {
        ...
        public RolContext(IMapper mapper)
        {
            _mapper = mapper;
        ...
        {
            var aux = _mapper.Map<ROL>(entity);
            _mandiolaDbContext.ROLs.Add(aux);
        ...
        public List<T> GetAll<T>()
            => _mapper.Map<List<T>>(_mandiolaDbContext.ROLs.ToList());
        ...
        public T GetById<T>(int id)
            => _mapper.Map<T>(_mandiolaDbContext.ROLs.FirstOrDefault(x => x.ID_ROL == id));
        ...
        {
            var aux = _mapper.Map<ROL>(entity);
            _mandiolaDbContext.ROLs.Attach(aux);
