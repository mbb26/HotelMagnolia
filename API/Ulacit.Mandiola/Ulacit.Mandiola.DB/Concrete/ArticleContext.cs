...
namespace Ulacit.Mandiola.DB.Concrete
{
    ...
    public class ArticleContext : IArticleContext
    {
        ...
        public List<T> GetAll<T>()
            => _mapper.Map<List<T>>(_mandiolaDbContext.ARTICULOes.ToList());
        ...
        public T GetById<T>(int id)
            => _mapper.Map<T>(_mandiolaDbContext.ARTICULOes.FirstOrDefault(x => x.ID_ARTICULO == id));
        ...
        {
            var aux = _mapper.Map<ARTICULO>(entity);
            _mandiolaDbContext.ARTICULOes.Attach(aux);
