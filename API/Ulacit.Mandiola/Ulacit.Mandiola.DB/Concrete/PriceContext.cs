...
namespace Ulacit.Mandiola.DB.Concrete
{
    ...
    public class PriceContext : IPriceContext
    {
        ...
        {
            var aux = _mapper.Map<PRECIO>(entity);
            _mandiolaDbContext.PRECIOs.Add(aux);
        ...
        public List<T> GetAll<T>()
            => _mapper.Map<List<T>>(_mandiolaDbContext.PRECIOs.ToList());
        ...
        public T GetById<T>(int id)
            => _mapper.Map<T>(_mandiolaDbContext.PRECIOs.FirstOrDefault(x => x.ID_PRECIO == id.ToString()));
        ...
        {
            var aux = _mapper.Map<PRECIO>(entity);
            _mandiolaDbContext.PRECIOs.Attach(aux);
