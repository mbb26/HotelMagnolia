...
namespace Ulacit.Mandiola.DB.Concrete
{
    ...
    public class BinnacleContext : IBinnacleContext
    {
        ...
        public BinnacleContext(IMapper mapper)
        {
            _mapper = mapper;
        ...
        public List<T> GetAll<T>()
            => _mapper.Map<List<T>>(_mandiolaDbContext.BITACORAs.ToList());
        ...
        public T GetById<T>(int id)
            => _mapper.Map<T>(_mandiolaDbContext.BITACORAs.FirstOrDefault(x => x.ID_BITACORA == id.ToString()));
        ...
        {
            var aux = _mapper.Map<BITACORA>(entity);
            _mandiolaDbContext.BITACORAs.Attach(aux);
