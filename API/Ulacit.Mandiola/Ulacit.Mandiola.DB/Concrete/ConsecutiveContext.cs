...
namespace Ulacit.Mandiola.DB.Concrete
{
    ...
    public class ConsecutiveContext : IConsecutiveContext
    {
        ...
        public List<T> GetAll<T>()
            => _mapper.Map<List<T>>(_mandiolaDbContext.CONSECUTIVOes.ToList());
        ...
        public T GetById<T>(int id)
            => _mapper.Map<T>(_mandiolaDbContext.CONSECUTIVOes.FirstOrDefault(x => x.ID_CONSECUTIVOS == id));
        ...
        {
            var aux = _mapper.Map<CONSECUTIVO>(entity);
            _mandiolaDbContext.CONSECUTIVOes.Attach(aux);
